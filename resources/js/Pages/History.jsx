                                            ...
                                            {job.platform_uploads.map(pu => {
                                                ...
                                                return (
                                                    <div key={pu.id} className={`inline-flex items-center px-2.5 py-1 rounded-full text-xs font-medium border ${colorClass} relative group`}>
                                                        ...
                                                        {(pu.status === 'done' || pu.status === 'success') && pu.platform_url && (
                                                            <a 
                                                                href={pu.platform_url} 
                                                                target="_blank" 
                                                                rel="noreferrer"
                                                                className="ml-2 bg-emerald-500/20 hover:bg-emerald-500/40 text-emerald-200 rounded-full p-0.5 transition-colors"
                                                                title={`Lihat detail postingan di ${pu.platform}`}
                                                            >
