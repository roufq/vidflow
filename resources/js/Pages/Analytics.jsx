            ...
            <div className="space-y-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                    ...
                    <div className="bg-[#111] border border-white/5 rounded-3xl p-6 shadow-lg">
                        ...
                        <p className="text-3xl font-bold text-white mb-2">{monthlyLimit === -1 ? '∞' : `${currentMonthUploads}/${monthlyLimit}`}</p>
                        <p className="text-xs font-medium text-slate-500 flex items-center gap-1">
                            Tersisa {monthlyLimit === -1 ? 'unlimited' : (monthlyLimit - currentMonthUploads)} upload bulan ini
                        </p>
                    </div>
